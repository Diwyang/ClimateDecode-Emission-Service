package com.climate.decode.event.emissions.freightmaterial.entity;
...
@Table(name = "freight_material_emission_calculation")
public class FreightMaterialEmissionData {
	...
	@Column(name = "freight_material_id")
